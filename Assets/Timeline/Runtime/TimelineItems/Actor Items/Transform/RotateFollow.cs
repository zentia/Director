...
namespace TimelineRuntime
{
    ...
    /// </summary>
    [TimelineItem("Transform", "Rotate to Follow", TimelineItemGenre.ActorItem, TimelineItemGenre.TransformItem)]
    public class RotateFollow : TimelineActorAction, IRecoverableObject
    {
        [SerializeField]
