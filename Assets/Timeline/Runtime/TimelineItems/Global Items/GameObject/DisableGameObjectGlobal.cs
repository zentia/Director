...
namespace TimelineRuntime
{
    ...
    /// </summary>
    [TimelineItem("Game Object", "Disable Game Object", TimelineItemGenre.GlobalItem)]
    public class DisableGameObjectGlobal : TimelineGlobalEvent, IRecoverableObject
    {
        ...
        {
            if (target != null)
                return new RevertInfo[] { new(this, target, "SetActive", target.activeInHierarchy) };
