...
namespace TimelineRuntime
{
    ...
    /// </summary>
    [TimelineItem("Utility", "Mass Disabler", TimelineItemGenre.GlobalItem)]
    public class MassDisabler : TimelineGlobalAction, IRecoverableObject
    {
        ...
        private List<GameObject> tagsCache = new();
