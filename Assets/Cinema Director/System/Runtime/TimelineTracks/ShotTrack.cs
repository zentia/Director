    ...
    public class ShotTrack : TimelineTrack
    {
        ...
        public override void UpdateTrack(float time, float deltaTime)
        {
            ...
            foreach (CinemaShot shot in GetTimelineItems())
            {
                ...
                if ((previousTime <= shot.CutTime) && (elapsedTime >= shot.CutTime) && (elapsedTime < endTime))
                {
                    shot.Trigger();
                    if (ShotBegins != null)
                    {
                ...
                else if ((previousTime >= endTime) && (elapsedTime < endTime) && (elapsedTime >= shot.CutTime))
                {
                    shot.Trigger();
                    if (ShotBegins != null)
                    {
                ...
                else if ((previousTime >= shot.CutTime) && (previousTime < endTime) && (elapsedTime >= endTime))
                {
                    shot.End();
                    if (ShotEnds != null)
                    {
                ...
                else if ((previousTime > shot.CutTime) && (previousTime < endTime) && (elapsedTime < shot.CutTime))
                {
                    shot.End();
                    if (ShotEnds != null)
                    {
                ...
                {
                    shot.UpdateTime(time, deltaTime);
                }
            }
        }
