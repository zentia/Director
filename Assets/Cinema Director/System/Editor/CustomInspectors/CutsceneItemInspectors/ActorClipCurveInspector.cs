...
public class ActorClipCurveInspector : Editor
{
    ...
    {
        actorClipCurve = new SerializedObject(target);
        editorRevert = actorClipCurve.FindProperty("editorRevertMode");
        runtimeRevert = actorClipCurve.FindProperty("runtimeRevertMode");
    }
