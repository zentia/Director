...
namespace CinemaDirector
{
	public class CinemaAnimationCurveWrapper
	{
		...
		public void AddKey(float time, float value, int tangentMode)
		{
			...
			AnimationKeyTime akt = AnimationKeyTime.Time(time, 30);
			time = (float) akt.m_Frame / 30;
		...
		public void PauseAtTime(float srcTime, float destTime)
		{
			AnimationKeyTime srcKeyTime = AnimationKeyTime.Time(srcTime, 30);
			AnimationKeyTime destKeyTime = AnimationKeyTime.Time(destTime, 30);
			...
			if (srcNum >= 0 && destNum >= 0)
			{
				...
				AddKey(destTime, srcKeyframe.value, 0);
			}
		}

		public void FlattenKey(int index)
		{
		...
		public void SetKeyLeftConstant(int index)
		{
			Keyframe keyframe = this.curve[index];
			Keyframe keyframe2 =
				new Keyframe(keyframe.time, keyframe.value, float.PositiveInfinity, keyframe.outTangent);
		...
		public void SetKeyRightConstant(int index)
		{
			Keyframe keyframe = this.curve[index];
			Keyframe keyframe2 =
				new Keyframe(keyframe.time, keyframe.value, keyframe.inTangent, float.PositiveInfinity);
        ...
        public void SetKeyFreeSmooth(int index)
		{
			Keyframe keyframe = this.curve[index];
			Keyframe keyframe2 = new Keyframe(keyframe.time, keyframe.value, keyframe.inTangent, keyframe.outTangent);
		...
		public bool IsFreeSmooth(int index)
		{
