...
{
    public abstract class CinemaClipCurve : TimelineItem
    {
        public List<MemberClipCurveData> curveData = new List<MemberClipCurveData>();
        ...
        public virtual void initializeClipCurves(MemberClipCurveData data, DirectorObject component, PropertyTypeInfo propertyTypeInfo = PropertyTypeInfo.None) 
        { 
        }

        public void AddClipCurveData(DirectorObject component, string name, bool isProperty, Type type)
        {
        ...
        {
            updateKeyframeTime(Firetime, firetime);
            Firetime = firetime;

            //updateKeyframeTime(base.Firetime + base.Duration, base.Firetime + duration);
            TimelineTrack.length = duration;
        }

        public void AlterDuration(float duration)
        {
            updateKeyframeTime(Firetime + Duration, Firetime + duration);
            Duration = duration;
        }
    }
}