...
namespace TimelineEditorInternal
{
    internal class AddCurvesPopup : EditorWindow
    {
        ...
        internal static TimelineWindowState s_State;
        ...
        {
            TimelineWindowUtility.CreateDefaultCurves(s_State, node.curveBindings);
            if (NewCurveAddedCallback != null)
                NewCurveAddedCallback(node);
        }

        internal static bool ShowAtPosition(Rect buttonRect, TimelineWindowState state, OnNewCurveAdded newCurveCallback)
        {
