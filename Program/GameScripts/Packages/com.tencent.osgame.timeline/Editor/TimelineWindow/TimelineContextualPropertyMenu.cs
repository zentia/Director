...
{
    internal class TimelinePropertyContextualMenu
    {
        public static TimelinePropertyContextualMenu Instance = new TimelinePropertyContextualMenu();

        ITimelineContextualResponder m_Responder;
        ...
        public TimelinePropertyContextualMenu()
        {
            EditorApplication.contextualPropertyMenu += OnPropertyContextMenu;
            MaterialEditor.contextualPropertyMenu += OnPropertyContextMenu;
        }

        public void SetResponder(ITimelineContextualResponder responder)
        {
            m_Responder = responder;
        }

        public bool IsResponder(ITimelineContextualResponder responder)
        {
