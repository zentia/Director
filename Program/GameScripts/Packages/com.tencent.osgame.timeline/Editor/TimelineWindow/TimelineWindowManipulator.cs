...
{
    internal class TimelineWindowManipulator
    {
        public delegate bool OnStartDragDelegate(TimelineWindowManipulator manipulator, Event evt);
        public delegate bool OnDragDelegate(TimelineWindowManipulator manipulator, Event evt);
        public delegate bool OnEndDragDelegate(TimelineWindowManipulator manipulator, Event evt);
        ...
        public TimelineWindowManipulator()
        {
            // NoOps...
            onStartDrag += (TimelineWindowManipulator manipulator, Event evt) => { return false; };
            onDrag += (TimelineWindowManipulator manipulator, Event evt) => { return false; };
            onEndDrag += (TimelineWindowManipulator manipulator, Event evt) => { return false; };
        }
    ...
    internal class AreaManipulator : TimelineWindowManipulator
    {
    ...
    internal class TimeCursorManipulator : TimelineWindowManipulator
    {
