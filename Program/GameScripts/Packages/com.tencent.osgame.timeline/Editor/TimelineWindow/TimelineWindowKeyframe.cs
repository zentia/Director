...
namespace TimelineEditorInternal
{
    internal class TimelineWindowKeyframe
    {
        ...
        public TimelineWindowKeyframe()
        {
        }

        public TimelineWindowKeyframe(TimelineWindowKeyframe key)
        {
            this.time = key.time;
        ...
        public TimelineWindowKeyframe(TimelineWindowCurve curve, Keyframe key)
        {
            this.time = key.time;
        ...
        public TimelineWindowKeyframe(TimelineWindowCurve curve, ObjectReferenceKeyframe key)
        {
            this.time = key.time;
            this.value = key.value;
            this.curve = curve;
