...
namespace TimelineEditor
{
    ...
    /// </summary>
    class TimelineEventEditorState
    {
        ...
        public TimelineEventEditorState()
        {
    ...
    internal class TimelineWindowEvent : ScriptableObject
    {
        ...
        static public TimelineWindowEvent CreateAndEdit(GameObject root, AnimationClip clip, float time)
        {
            ...
            TimelineWindowEvent animationWindowEvent = CreateInstance<TimelineWindowEvent>();
