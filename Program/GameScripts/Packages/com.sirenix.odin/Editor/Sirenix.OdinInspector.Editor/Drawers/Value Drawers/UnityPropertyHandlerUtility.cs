...
#pragma warning disable
    ...
    internal static class UnityPropertyHandlerUtility
    {
        ...
        private const string PropertyHandler_PropertyDrawerName = "m_PropertyDrawers";
        ...
        private static readonly Action<object, List<PropertyDrawer>> PropertyHandler_SetPropertyDrawer;
        ...
        public static object CreatePropertyHandler(PropertyDrawer drawer)
        {
            ...
            PropertyHandler_SetPropertyDrawer(handler, new List<PropertyDrawer>(){drawer});
            return handler;
        }
    }
}
