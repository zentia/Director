...
namespace TimelineRuntime
{
    ...
    public static class UnityPropertyTypeInfo
    {
        ...
        {
            if (info == PropertyTypeInfo.Int || info == PropertyTypeInfo.Long || info == PropertyTypeInfo.Float || info == PropertyTypeInfo.Double || info == PropertyTypeInfo.Bool || info == PropertyTypeInfo.Enum)
            {
                return 1;
            }
            if (info == PropertyTypeInfo.Vector2)
            {
                return 2;
            }
            if (info == PropertyTypeInfo.Vector3)
            {
                return 3;
            }
            if (info == PropertyTypeInfo.Vector4 || info == PropertyTypeInfo.Quaternion || info == PropertyTypeInfo.Color)
            {
                return 4;
            }
            return 0;
        ...
        public static string GetCurveName(PropertyTypeInfo info, int i)
        {
            ...
            if (info == PropertyTypeInfo.Int || info == PropertyTypeInfo.Long || info == PropertyTypeInfo.Float ||
                info == PropertyTypeInfo.Double || info == PropertyTypeInfo.Bool || info == PropertyTypeInfo.Enum)
            {
                retVal = "value";
            }
